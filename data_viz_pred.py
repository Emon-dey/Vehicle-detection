...
parser = argparse.ArgumentParser(description='PointGNN')
...
parser.add_argument('--dataset_root_dir', type=str, default='D:/Desktop/data_object/',
                   help='Path to KITTI dataset')
parser.add_argument('--dataset_split_file', type=str,
                    default='test_car.txt',
...
if IS_TEST:
    dataset = KittiDataset(
        os.path.join(DATASET_DIR, 'image_2/testing/image_2'),
    ...
    dataset = KittiDataset(
        os.path.join(DATASET_DIR, 'image_2/training/image_2'),
        os.path.join(DATASET_DIR, 'velodyne/training/velodyne/'),
        os.path.join(DATASET_DIR, 'calib/training/calib/'),
        os.path.join(DATASET_DIR, 'label_2/training/label_2'),
        DATASET_SPLIT_FILE,
        num_classes=config['num_classes'])
